...
Spacebrew.Client = function( server, name, description, options ){
        ...
        this.debug = ((window && window.getQueryString('debug') === "true" )? true : (options.debug || false));
...
Spacebrew.Client.prototype.connectIOs = function (action, ioFrom, ioTo) {
    var msg = {
        "route":
        {
            "type": action,
...
Spacebrew.Client.prototype.rawSend = function(msg) {
